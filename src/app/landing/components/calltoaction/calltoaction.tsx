  ...
  return (
    <div className='w-screen h-[300px] bg-[#0d333f]'>
        ...
        <div className='w-[100%] flex justify-center items-center pt-10'>
            <button className='ml-7 mt-6 p-3 border-2 text-lg rounded-md mr-3 border-white text-gray-300 font-medium transition-all ease-in duration-300 hover:bg-white hover:text-[#0d333f]'>Register for free</button>
        </div>
    </div>
  )
}
